...
F2POSRSRanks::Application.configure do
   config.version = "F2P OSRS Ranks v0.2.4a"
...
skills = ["overall", "attack", "defence", "strength", "hitpoints", "ranged", "prayer",
          "magic", "cooking", "woodcutting", "p2p", "fishing", "firemaking", "crafting",
          "smithing", "mining", "p2p", "p2p", "p2p", "p2p", "p2p", "runecraft", "p2p", 
          "p2p", "p2p", "p2p", "p2p", "p2p", "p2p", "p2p", "lms", "p2p", "p2p"]
...
ehp_reg['defence_xphrs'] = [7200, 14400, 28900, 43000, 51000, 57800, 63000, 68000]
...
ehp_reg['prayer_tiers'] = [0, 160000000]
ehp_reg['prayer_xphrs'] =[43000, 267000]
...
ehp_reg['smithing_xphrs'] = [40000, 103000, 220000, 275000, 30000000]
...
ehp_reg['runecraft_xphrs'] = [40000]



ehp_iron['attack_tiers'] = [0, 37224, 100000, 1000000, 1986068, 3000000, 5346332, 13034431]
ehp_iron['attack_xphrs'] = [5000, 10000, 20000, 30000, 35000, 40000, 44000, 47000]

ehp_iron['defence_tiers'] = [0, 37224, 100000, 1000000, 1986068, 3000000, 5346332, 13034431]
ehp_iron['defence_xphrs'] = [5000, 10000, 20000, 30000, 35000, 40000, 44000, 47000]

ehp_iron['strength_tiers'] = [0, 37224, 100000, 1000000, 1986068, 3000000, 5346332, 13034431] 
ehp_iron['strength_xphrs'] = [5000, 10000, 20000, 30000, 35000, 40000, 44000, 47000]

ehp_iron['hitpoints_tiers'] = [0]
ehp_iron['hitpoints_xphrs'] = [0]

ehp_iron['ranged_tiers'] = [0, 37224, 100000, 1000000, 1986068, 3000000, 5346332, 13034431] 
ehp_iron['ranged_xphrs'] = [4000, 9000, 17000, 27000, 30000, 35000, 40000, 42000]

ehp_iron['prayer_tiers'] = [0]
ehp_iron['prayer_xphrs'] = [15200]

ehp_iron['magic_tiers'] = [0, 3973, 33648]
ehp_iron['magic_xphrs'] = [5000, 34800, 56100]

ehp_iron['cooking_tiers'] = [0]
ehp_iron['cooking_xphrs'] = [0]

ehp_iron['woodcutting_tiers'] = [0, 2411, 13363, 41171, 9800000]
ehp_iron['woodcutting_xphrs'] = [6000, 12000, 24000, 34700, 72000]

ehp_iron['fishing_tiers'] = [0, 4470, 13363, 273742, 737627, 2500000, 6000000, 9600000]
ehp_iron['fishing_xphrs'] = [12000, 22000, 26000, 28000, 30000, 32000, 38000, 72000]

ehp_iron['firemaking_tiers'] = [0]
ehp_iron['firemaking_xphrs'] = [0]

ehp_iron['crafting_tiers'] = [0]
ehp_iron['crafting_xphrs'] = [13300]

ehp_iron['smithing_tiers'] = [0]
ehp_iron['smithing_xphrs'] = [8100]

ehp_iron['mining_tiers'] = [0]
ehp_iron['mining_xphrs'] = [0]

ehp_iron['runecraft_tiers'] = [0]
ehp_iron['runecraft_xphrs'] = [4285]



ehp_uim['attack_tiers'] = [0, 37224, 100000, 1000000, 1986068, 3000000, 5346332, 13034431]
ehp_uim['attack_xphrs'] = [5000, 10000, 20000, 30000, 35000, 40000, 44000, 47000]

ehp_uim['defence_tiers'] = [0, 37224, 100000, 1000000, 1986068, 3000000, 5346332, 13034431]
ehp_uim['defence_xphrs'] =  [5000, 10000, 20000, 30000, 35000, 40000, 44000, 47000]

ehp_uim['strength_tiers'] = [0, 37224, 100000, 1000000, 1986068, 3000000, 5346332, 13034431] 
ehp_uim['strength_xphrs'] = [5000, 10000, 20000, 30000, 35000, 40000, 44000, 47000]

ehp_uim['hitpoints_tiers'] = [0]
ehp_uim['hitpoints_xphrs'] = [0]

ehp_uim['ranged_tiers'] = [0, 37224, 100000, 1000000, 1986068, 3000000, 5346332, 13034431]
ehp_uim['ranged_xphrs'] = [4000, 9000, 17000, 27000, 30000, 35000, 40000, 42000]

ehp_uim['prayer_tiers'] = [0]
ehp_uim['prayer_xphrs'] = [15200]

ehp_uim['magic_tiers'] = [0, 3973, 33648]
ehp_uim['magic_xphrs'] = [5000, 34800, 45600]

ehp_uim['cooking_tiers'] = [0] 
ehp_uim['cooking_xphrs'] = [0]

ehp_uim['woodcutting_tiers'] = [0, 2411, 13363, 41171, 9800000]
ehp_uim['woodcutting_xphrs'] = [6000, 12000, 24000, 34700, 72000]

ehp_uim['fishing_tiers'] = [0, 4470, 13363, 273742, 737627, 2500000, 6000000, 9600000] 
ehp_uim['fishing_xphrs'] = [12000, 22000, 26000, 28000, 30000, 32000, 38000, 72000]

ehp_uim['firemaking_tiers'] = [0]
ehp_uim['firemaking_xphrs'] = [0]

ehp_uim['crafting_tiers'] = [0] 
ehp_uim['crafting_xphrs'] = [0]

ehp_uim['smithing_tiers'] = [0, 9800000]
ehp_uim['smithing_xphrs'] = [4800, 6900]

ehp_uim['mining_tiers'] = [0] 
ehp_uim['mining_xphrs'] =[0]

ehp_uim['runecraft_tiers'] = [0] 
ehp_uim['runecraft_xphrs'] = [3500]
