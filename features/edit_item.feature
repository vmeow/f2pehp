...
Feature: Edit an existing item
    ...
    Given the following items exist:
      | client_ssn | client_name  | date_opened | case_id     |
      | 111111111  | John Doe     | 10-Nov-2017 | 20171110001 |
    
    Scenario: Check that the index page to edit page button works
      Given I am on the items index page
      When  I follow "Edit"  
      Then  I should see "Edit Case"
      
    Scenario: Check that the show page to edit page button works
      Given I am on the show item page for "111111111"
      When  I follow "Edit"  
      Then  I should see "Edit Case"
      
    Scenario: Check that edited data persists
