...
class Player < ActiveRecord::Base
  ...
  SUPPORTERS = [{name: "Bargan", amount: 270.82, date: "2020-07-19"},
                ...
                {name: "Iron of One", amount: 20, date: "2020-08-25", flair_after: "items/Dark_cavalier.png"},
                ...
                {name: "SkyraHC", amount: 5, date: "2020-08-29", flair_after: "flairs/rune_scimitar_(zamorak).png"},
