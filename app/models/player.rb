...
class Player < ActiveRecord::Base
  ...
  SUPPORTERS = [{name: "Bargan", amount: 290.82, date: "2021-08-30"},
                ...
                {name: "Vammanen Yui", amount: 5, date: "2022-03-02", flair_after: "flairs/loonix.png", other_css: ["color: #910599"]},
                {name: "Jmd992", amount: 5, date: "2022-03-03", flair_after: "flairs/Diamond.png"},
